    ...
    methods
        ...
        function create_layout(obj)
            ...
            button_string = ['<html><div style="text-align: center"><img src="' icon_url '"/>' ...
                   '<br>Welcome to <b>Hunter</b>, a simulator to study cooperative hunting by multirobots...' ...
                   '<br><ol><li>Start by clicking the play button.</li><li>Double-click to send the red robot to a new location.</li><li>Use the mouse to pan and zoom.</li><li>Select the robot to follow it</li><li>If any robot crashes, press the rewind button.</li></ol>' ...
                   '</html>'];
            ui_args = {'Style','pushbutton', 'String', button_string, 'ForegroundColor', 'y', 'FontWeight', 'bold', 'BackgroundColor', obj.ui_colors_.gray, 'Callback', @obj.ui_button_start};
